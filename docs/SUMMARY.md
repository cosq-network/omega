...
| **Static POSIX commands** | 14 standalone musl-linked utilities for the three reference ISAs | ELF builds and `/bin/echo` `execve` probe pass on all three; filesystem runtime coverage remains in progress |
